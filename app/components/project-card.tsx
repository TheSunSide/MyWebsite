...
export function ProjectCard({item, projectLink}: {item: ProjectDesc, projectLink: string}) {
  ...
  return (
    <div key={item.name} className="grid grid-cols-1 content-between justify-items-center mx-auto mt-2 w-4/5 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <a href={projectLink} className="w-fit inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
